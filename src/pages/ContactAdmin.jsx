      ...
      >
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
          <div className="navbar-nav mx-auto py-2 text-uppercase fw-semibold">
            ...
            <Link to="/admin/contactoAdmin" className="nav-item nav-link active text-primary" style={{ fontSize: '1.2rem' }}>
              Contacto
            </Link>
            <Link to="/admin/dashboard" className="nav-item nav-link active text-primary" style={{ fontSize: '1.2rem' }}>
              Dashboard
            </Link>
